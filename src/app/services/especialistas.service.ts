...
import { Departamento, Ciudad, Especialista, Institucion, Paciente } from '../models/interfaces';

@Injectable({ providedIn: 'root' })
export class EspecialistasService {
  private http = inject(HttpClient);

  loadAll(): Observable<[Departamento[], Ciudad[], Especialista[], Institucion[], Paciente[]]> {
    return forkJoin([
